                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="SignUP/">
                        <div class="input-group">
                            <input class="input--style-2" type="text" placeholder="First name" name=" First name" id="fname">
                        </div>
						<div class="input-group">
							<input class="input--style-2" type="text" placeholder="Second name" name=" Second name" id="lname">
						</div>
